...
import CreditLimitRequestModal from '@/components/modals/CreditLimitRequestModal';
...
=====================================================`;
  ...
  return (
    <div className="bg-[#f8fafc] min-h-screen font-sans text-gray-900 flex">
      
      {/* 1. LEFT SIDEBAR NAVIGATION */}
      <aside className="w-64 bg-white border-r border-gray-200 shrink-0 hidden lg:flex flex-col justify-between p-4 sticky top-0 h-screen overflow-y-auto">
        <div className="space-y-6">
          
          {/* Brand Logo & Company Title */}
          <div className="flex items-center gap-3 px-2 py-1">
            <div className="w-8 h-8 rounded-xl bg-[#004e38] text-white flex items-center justify-center font-black shadow-xs">
              <ShoppingBag className="w-4 h-4" />
            </div>
            <div>
              <span className="text-base font-black text-gray-900 tracking-tight block">Shopcart B2B</span>
              <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block">Painel da Empresa</span>
            </div>
          </div>

          {/* Dedicated Subpages Links */}
          <nav className="space-y-1 text-xs font-semibold">
            
            <Link
              href="/conta"
              className="w-full flex items-center justify-between px-3 py-2.5 rounded-xl transition-all bg-emerald-50 text-[#004e38] font-extrabold shadow-2xs"
            >
            ...
            <Link
              href="/conta/pedidos"
              className="w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-all"
            >
              <div className="flex items-center gap-3">
                <ShoppingBag className="w-4 h-4" />
                <span>Pedidos Faturados</span>
              </div>
              <span className="bg-emerald-100 text-[#004e38] text-[10px] font-black px-2 py-0.5 rounded-full">46</span>
            </Link>

            <Link
              href="/conta/tabelas-de-precos"
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-all"
            >
              <Tag className="w-4 h-4 text-[#004e38]" />
              <span>Tabelas de Preços (Price Books)</span>
            </Link>
            ...
            >
              ...
              <span>RMA & Devolução de Lotes</span>
            </Link>

            <Link
              href="/conta/contratos"
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-all"
            >
              <FileCheck2 className="w-4 h-4 text-emerald-600" />
              <span>Contratos de Fornecimento</span>
            </Link>
            ...
            >
              ...
              <span>Monitor ERPs & Webhooks</span>
            </Link>
            ...
            <Link
              href="/conta/estoque"
              className="w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-[#004e38] bg-emerald-50/50 hover:bg-emerald-100 font-extrabold transition-all border border-emerald-200"
            >
              <div className="flex items-center gap-3">
                <Boxes className="w-4 h-4 text-[#004e38]" />
                <span>Gestão de Estoque (Vendedor)</span>
              </div>
              <span className="bg-[#004e38] text-white text-[9px] font-mono px-1.5 py-0.5 rounded uppercase">Novo</span>
            </Link>

            <Link
              href="/conta/personalizacao"
              className="w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-purple-900 bg-purple-50/70 hover:bg-purple-100 font-extrabold transition-all border border-purple-200"
            >
              <div className="flex items-center gap-3">
                <Paintbrush className="w-4 h-4 text-purple-700" />
                <span>Personalização da Vitrine (SaaS)</span>
              </div>
              <span className="bg-purple-700 text-white text-[9px] font-mono px-1.5 py-0.5 rounded uppercase">Storefront</span>
            </Link>
            ...
            >
              ...
              <span>Clientes & Filiais CNPJ</span>
            </Link>
            ...
            >
              ...
              <span>Faturas & 2ª Via Boletos</span>
            </Link>

            <Link
              href="/conta/analise-tributaria"
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-all"
            >
              <TrendingUp className="w-4 h-4" />
              <span>Relatórios Tributários</span>
            </Link>
            ...
            <Link
              href="/faq"
              className="flex items-center gap-3 px-3 py-2.5 text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-xl transition-all"
            >
        ...
        {/* Promo Upgrade Box */}
        <div className="bg-gradient-to-br from-[#004e38] to-[#033627] text-white p-4 rounded-2xl space-y-3 shadow-md">
          <div className="flex items-center gap-2 text-amber-300 text-xs font-extrabold">
            <Sparkles className="w-4 h-4" />
            <span>Mesa de Crédito B2B</span>
          </div>
          <p className="text-[11px] text-emerald-100 leading-relaxed">
            Aumente seu limite de faturamento faturado em até <strong>R$ 120.000,00</strong> sob análise fiscal.
          </p>
          <button
            onClick={() => setIsCreditModalOpen(true)}
            className="w-full bg-white hover:bg-emerald-50 text-[#004e38] font-extrabold text-xs py-2 rounded-xl transition-colors cursor-pointer"
          >
            Solicitar Expansão de Limite
          </button>
        </div>
      </aside>
      ...
      <main className="flex-1 min-w-0 overflow-y-auto pb-16">
        ...
        <header className="bg-white border-b border-gray-200 px-6 py-4 sticky top-0 z-30 flex items-center justify-between gap-4">
          ...
          <div className="relative max-w-md w-full">
            <input
              ...
              className="w-full bg-[#f5f6f6] focus:bg-white border border-transparent focus:border-[#004e38] rounded-full py-2 pl-4 pr-10 text-xs font-medium focus:outline-none transition-all"
            />
          ...
          <div className="flex items-center gap-3 text-xs font-bold shrink-0">
            ...
            <div className="hidden sm:flex items-center gap-1 bg-[#f5f6f6] px-3 py-1.5 rounded-full border border-gray-200 text-gray-700">
              <Calendar className="w-3.5 h-3.5 text-[#004e38]" />
              <select
                value={dateRange}
                onChange={(e) => {
            ...
            >
              <Plus className="w-4 h-4 text-[#004e38]" />
            ...
            <button
              ...
              className="flex items-center gap-1.5 bg-[#004e38] hover:bg-[#033627] text-white px-5 py-2 rounded-full transition-all shadow-xs cursor-pointer"
            >
            ...
            <button className="p-2 rounded-full hover:bg-gray-100 text-gray-600 relative cursor-pointer">
              ...
              <span className="w-2 h-2 bg-emerald-600 rounded-full absolute top-1.5 right-1.5"></span>
            </button>
            ...
            >
              <div className="w-7 h-7 rounded-full bg-[#004e38] text-white font-bold flex items-center justify-center text-xs">
        ...
        <div className="p-6 lg:p-8 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 bg-emerald-50 text-[#004e38] px-4 py-2 rounded-2xl border border-emerald-200 text-xs font-bold">
          ...
          <div className="bg-[#f5f6f6] border border-gray-200 p-3.5 rounded-2xl flex items-center justify-between text-xs text-gray-600 font-medium">
            <div className="flex items-center gap-2">
              <GripVertical className="w-4 h-4 text-[#004e38]" />
              <span>
            ...
            <button
              onClick={() => setIsAddWidgetOpen(true)}
              className="text-[10px] bg-white text-[#004e38] font-extrabold px-3 py-1 rounded-md border border-gray-200 hover:bg-emerald-50"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            {widgets.map((widget, index) => {
              ...
              return (
                ...
                >
                  {/* WIDGET CONTAINER */}
                  <div className="bg-white p-6 rounded-3xl border border-gray-200 space-y-4 shadow-2xs group hover:border-[#004e38] relative">
                    ...
                    <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-extrabold text-[#004e38] bg-emerald-50 px-2 py-0.5 rounded uppercase">
                          {widget.category}
                        </span>
                      ...
                      <div className="space-y-2 pt-1">
                        <div className="flex items-baseline justify-between">
                          ...
                          <span className={`text-xs font-bold px-2.5 py-0.5 rounded-md flex items-center gap-0.5 ${
                            widget.id === 'kpi-clicks' ? 'bg-red-50 text-red-600' : 'bg-emerald-50 text-emerald-700'
                          }`}>
                      ...
                      <div className="space-y-4">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                          <div className="space-y-1">
                            ...
                            <span className="text-xs font-bold text-emerald-700 bg-emerald-50 px-2.5 py-0.5 rounded-md inline-flex items-center gap-1">
                              <ArrowUpRight className="w-3.5 h-3.5" /> +24,4% vs. período anterior
                            </span>
                          </div>

                          <div className="flex items-center gap-2 text-[11px] font-bold">
                            <span className="bg-[#004e38] text-white px-3 py-1 rounded-full cursor-pointer">Varejistas (2.884)</span>
                        ...
                        <div className="relative h-48 w-full bg-[#f8fafc] rounded-2xl p-4 flex flex-col justify-between border border-gray-100 overflow-hidden">
                          <svg className="absolute inset-0 w-full h-full p-4 overflow-visible" preserveAspectRatio="none" viewBox="0 0 500 150">
                            <defs>
                              <linearGradient id="chartGrad" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="0%" stopColor="#004e38" stopOpacity="0.25" />
                                <stop offset="100%" stopColor="#004e38" stopOpacity="0" />
                              </linearGradient>
                            </defs>
                            ...
                            <path d="M 0 100 Q 80 40, 160 90 T 320 30 T 500 60" fill="none" stroke="#004e38" strokeWidth="3" />
                            <circle cx="320" cy="30" r="5" fill="#004e38" stroke="#ffffff" strokeWidth="2" />
                          </svg>
                          ...
                          <div className="absolute top-4 left-[58%] bg-white shadow-xl border border-gray-200 p-2 rounded-xl text-[10px] space-y-0.5 z-10 animate-bounce">
                            ...
                            <p className="font-black text-[#004e38]">R$ 112.324 este mês</p>
                          </div>
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full text-left text-xs">
                          ...
                          <tbody className="divide-y divide-gray-50 font-medium">
                            {[
                              { sku: '#83009', name: 'AirPods Max High-Fi Studio Edition', sold: '2.310 lotes', revenue: 124839, img: '/media/airpods_max_pink.jpg' },
                              { sku: '#83001', name: 'Wireless Earbuds IPX8 Noise Canceling', sold: '1.230 lotes', revenue: 92662, img: '/media/wireless_earbuds.jpg' },
                              { sku: '#83004', name: 'Bose BT Headset Pro ANC', sold: '812 lotes', revenue: 74048, img: '/media/img3.jpeg' },
                            ].map((row, idx) => (
                              <tr key={idx} className="hover:bg-[#f5f6f6]/60 transition-colors">
                                ...
                                <td className="py-2.5 text-right font-black text-[#004e38]">
                      ...
                      <div className="flex items-end justify-between h-36 pt-4 px-2">
                        {[
                          ...
                          <div key={i} className="flex flex-col items-center gap-2 flex-1">
                            {bar.active && (
                              <span className="text-[9px] font-black text-[#004e38] bg-emerald-50 px-1.5 py-0.5 rounded border border-emerald-200">
                                8.162
                              </span>
                            )}
                            <div style={{ height: `${bar.val}%` }} className={`w-4 rounded-t-lg transition-all ${bar.active ? 'bg-[#004e38]' : 'bg-gray-200'}`} />
                            <span className={`text-[10px] font-bold ${bar.active ? 'text-[#004e38]' : 'text-gray-400'}`}>{bar.day}</span>
                          </div>
                        ))}
                      </div>
                    )}
                      ...
                      <div className="space-y-3">
                        <div className="h-32 overflow-y-auto space-y-2 bg-[#f8fafc] p-3 rounded-2xl border border-gray-100 text-xs">
                          {aiMessages.map((msg, i) => (
                            <div key={i} className={`p-2 rounded-xl text-[11px] ${msg.sender === 'user' ? 'bg-[#004e38] text-white ml-auto' : 'bg-white text-gray-800 border border-gray-200'}`}>
                              {msg.text}
                            </div>
                          ))}
                        </div>
                        <form onSubmit={handleSendAiPrompt} className="relative">
                          ...
                          />
                          <button type="submit" className="w-6 h-6 rounded-full bg-[#004e38] text-white flex items-center justify-center absolute right-1.5 top-1.5">
          ...
          <div className="bg-white text-gray-900 rounded-3xl shadow-2xl border border-gray-100 w-full max-w-xl overflow-hidden relative max-h-[85vh] flex flex-col">
            ...
            <div className="p-6 overflow-y-auto space-y-3 divide-y divide-gray-100 flex-1 text-xs">
              {widgets.map((widget) => (
                <div key={widget.id} className="pt-3 first:pt-0 flex items-center justify-between gap-4">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <span className="text-[10px] font-bold text-[#004e38] bg-emerald-50 px-2 py-0.5 rounded uppercase">
                        {widget.category}
                      </span>
            ...
            <div className="p-4 bg-[#f5f6f6] border-t border-gray-100 flex justify-end shrink-0">
              <button
                ...
                className="bg-[#004e38] hover:bg-[#033627] text-white font-bold text-xs px-6 py-2.5 rounded-full transition-all shadow-xs"
              >
      ...
      {/* MODAL DE SOLICITAÇÃO DE LIMITE DE CRÉDITO */}
