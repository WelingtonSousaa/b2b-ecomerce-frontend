        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
            <div className="bg-[#f5f6f6] p-5 rounded-2xl border border-gray-200 space-y-2">
              <div className="flex items-center gap-2 text-[#004e38] font-black">
        ...
        <div className="space-y-4 text-xs text-gray-700 leading-relaxed border-t border-gray-100 pt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-3xl border border-gray-200 space-y-2 shadow-2xs">
              <span className="bg-[#004e38] text-white text-[10px] font-black px-2.5 py-1 rounded">FRETE CIF (Shopcart Contrata)</span>
              <h3 className="text-base font-bold text-gray-900 pt-1">Frete Pago e Gerenciado pela Shopcart</h3>
              <p className="text-gray-600">
                A Shopcart assume total responsabilidade pela cotação, embarque, seguro e entrega do pedido. Disponível com **Frete Grátis** para compras corporativas acima de R$ 200,00.
              </p>
            </div>

            <div className="bg-white p-6 rounded-3xl border border-gray-200 space-y-2 shadow-2xs">
              <span className="bg-[#004e38] text-white text-[10px] font-black px-2.5 py-1 rounded">FRETE FOB (Cliente Contrata)</span>
