      ...
      <div className="max-w-[1440px] mx-auto px-4 lg:px-12 space-y-12">
        ...
        <div className="bg-[#f9ece4] rounded-3xl p-8 lg:p-14 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#2563eb] tracking-tight leading-tight">
            ...
            <p className="text-xs sm:text-sm text-gray-700 leading-relaxed max-w-2xl">
              Fundada em 2018, a <strong>OneSync Brasil Ltda.</strong> nasceu com a missão de eliminar a burocracia do compras corporativas (Procurement B2B). Conectamos indústrias, revendedores e grandes corporações através de uma plataforma com inteligência tributária automatizada, estoque distribuído em múltiplos Centros de Distribuição e concessão rápida de limite de crédito.
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 bg-[#f5f6f6] p-8 rounded-3xl text-center">
          <div className="space-y-1">
            <div className="text-3xl font-black text-[#2563eb]">R$ 450M+</div>
            <p className="text-xs font-semibold text-gray-600">Volume Faturado em B2B</p>
          </div>
          <div className="space-y-1">
            <div className="text-3xl font-black text-[#2563eb]">12.000+</div>
            <p className="text-xs font-semibold text-gray-600">Empresas Cadastradas</p>
          </div>
          <div className="space-y-1">
            <div className="text-3xl font-black text-[#2563eb]">3 CDs</div>
            <p className="text-xs font-semibold text-gray-600">São Paulo, Joinville & Camaçari</p>
          </div>
          <div className="space-y-1">
            <div className="text-3xl font-black text-[#2563eb]">99.4%</div>
        ...
        {/* CTA Box */}
        <div className="bg-[#2563eb] text-white p-8 lg:p-12 rounded-3xl flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-2">
            <h3 className="text-2xl font-black">Pronto para abastecer sua empresa com a OneSync?</h3>
          ...
          <Link
            href="/cadastro"
            className="bg-white hover:bg-blue-50 text-[#2563eb] font-bold text-xs px-8 py-3.5 rounded-full transition-all shadow-md shrink-0 flex items-center gap-2"
          >
