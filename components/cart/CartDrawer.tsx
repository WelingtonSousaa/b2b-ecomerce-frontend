      ...
      <div className="fixed inset-0 z-50 overflow-hidden animate-in fade-in duration-200 font-sans">
        ...
        <div className="fixed inset-y-0 right-0 max-w-full flex pl-10">
          <div className="w-screen max-w-md bg-white shadow-2xl flex flex-col justify-between">
            ...
            {/* Header */}
            <div className="p-5 bg-[#004e38] text-white flex items-center justify-between">
              ...
              {items.length === 0 ? (
                <div className="text-center py-16 space-y-3">
                  ...
                  <Link
                    href="/produtos"
                    onClick={onClose}
                    className="inline-block bg-[#004e38] text-white text-xs font-bold px-6 py-2.5 rounded-full hover:bg-[#033627] transition-colors mt-2"
                  >
                    Explorar Produtos
                  </Link>
                </div>
                  ...
                  <div key={item.id} className="pt-4 first:pt-0 flex gap-4">
                    ...
                    <div className="flex-1 space-y-1.5">
                      ...
                      <div className="flex items-center justify-between text-xs pt-1">
                        ...
                        <span className="font-black text-[#004e38]">
            ...
            <div className="px-6 py-2 bg-emerald-50/50 border-t border-emerald-100 text-xs">
              <button
                onClick={() => setShowTaxDetails(!showTaxDetails)}
                className="w-full flex items-center justify-between font-bold text-[#004e38] text-[11px] cursor-pointer py-1"
              >
              ...
              {showTaxDetails && (
                <div className="pt-2 space-y-1.5 text-[10px] text-gray-600 border-t border-emerald-200 mt-1">
            ...
            <div className="p-6 bg-[#f5f6f6] border-t border-gray-100 space-y-3">
              <div className="flex items-center justify-between text-sm font-black text-gray-900">
                ...
                <span className="text-[#004e38] text-base">R$ {subtotal.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 pt-1">
                <button
                  ...
                  className="bg-white hover:bg-emerald-50 text-[#004e38] border border-emerald-300 py-3 rounded-full text-xs font-bold flex items-center justify-center gap-1.5 transition-all cursor-pointer shadow-2xs"
                >
                ...
                <Link
                  href="/checkout"
                  onClick={onClose}
                  className="bg-[#004e38] hover:bg-[#033627] text-white py-3 rounded-full text-xs font-bold text-center flex items-center justify-center gap-1.5 transition-all shadow-sm"
                >
                  <span>Checkout</span>
