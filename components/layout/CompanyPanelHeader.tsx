  ...
  return (
    <div className="bg-white border-b border-gray-200 shadow-2xs">
      <div className="max-w-[1440px] mx-auto px-4 lg:px-12 pt-6 pb-2 space-y-5">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-gradient-to-r from-blue-950 via-[#2563eb] to-[#023b2b] text-white p-4 sm:p-5 rounded-3xl shadow-sm">
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div className="space-y-0.5 min-w-0">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="bg-blue-400/20 text-blue-300 border border-blue-400/30 text-[9px] font-mono font-bold px-2 py-0.5 rounded-full uppercase">
                  CNPJ Ativo
                </span>
          ...
          <div className="flex flex-wrap items-center gap-4 text-xs font-semibold shrink-0">
            <div className="bg-black/20 border border-white/10 px-4 py-2.5 rounded-2xl space-y-1.5 min-w-[200px]">
              ...
              <div className="flex justify-between text-[9px] text-blue-300/80">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-1">
            <div>
              <div className="flex items-center gap-2">
                ...
                {activeBadge && (
                  <span className="bg-blue-100 text-[#2563eb] font-bold text-xs px-2.5 py-0.5 rounded-full">
                    {activeBadge}
                  </span>
                )}
              </div>
